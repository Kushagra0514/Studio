...
class RetrievalPipeline:
    ...
    def answer_question(self, question: str, chat_history: list = None) -> dict:
        ...
        if intent == "CONVERSATIONAL":
            ...
            conv_msgs = [{"role": "system", "content": "You are a helpful, friendly AI assistant."}]
            ...
            return {
                "answer": conv_response.choices[0].message.content,
                "sources": []
            }
            ...
            try:
                ...
                for i, r in enumerate(web_results[:10]):
                    results.append(ScoredPoint(
                        ...
                        version=0,
                        score=1.0,
                        payload={"text": f"Title: {r.title}\nSnippet: {r.description}", "source": r.url}
                    ))
