...
def main():
    ...
    points = response[0]
    if not points:
        print("No chunks found in the database. Please run 'python main.py ingest <pdf>' first.")
        return
    ...
    if os.path.exists("dataset.json"):
        ...
        existing = [item for item in existing if item.get("question") != "What is the cost of attending for undergrads?"]
